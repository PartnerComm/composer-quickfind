...
class PCQF_Admin
{
  ...
  public static function pcqf_create_menu() 
  {
    ...
    add_submenu_page( 'pcomm-quick-find', "Post Type Settings", "Post Type Settings", 'manage_options', "post-type-settings", 'PCQF_Admin::pcqf_type_settings_page');
    });
  ...
  */
  ...
  public static function pcqf_get_edit_group_post_form() 
  {
    ...
    $table .= '<h4>' . $current_post->post_title . '</h4>';
